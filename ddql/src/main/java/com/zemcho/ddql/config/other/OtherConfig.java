package com.zemcho.ddql.config.other;
...
public class OtherConfig {
    ...
    //app端小程序码跳转页面
    private String appCheckInQRPage;

    //app端小程序码环境
    private String appCheckInQREnv;

    //app端小程序码跳转页面
    private String teamInvitationQRPage;

    // 分账时间限制
    private Integer divideTimeLimit;
}
