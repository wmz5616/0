...
public class RedisConfig {
    ...
    public RedisMessageListenerContainer redisMessageListenerContainer(@Qualifier("jedisConnectionFactory") JedisConnectionFactory factory,
                                                                       @Qualifier("redisListener") RedisListener messageListener){
