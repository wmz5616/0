package com.zemcho.ddql.config.shiro;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean webFilter() {
        ...
        filterChainMap.put("/wechat/place/lists", "anon");
        filterChainMap.put("/wechat/product/category/lists", "anon");
        filterChainMap.put("/wechat/product/lists", "anon");
        filterChainMap.put("/wechat/product/info", "anon");
        filterChainMap.put("/wechat/common/article/list", "anon");
        filterChainMap.put("/wechat/common/notice/list", "anon");
        filterChainMap.put("/wechat/common/check_in_type/list", "anon");
        filterChainMap.put("/wechat/recharge/order/pay/callback", "anon");
        filterChainMap.put("/homePage/banner/showList", "anon");
