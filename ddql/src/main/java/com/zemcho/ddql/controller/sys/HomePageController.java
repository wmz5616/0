...
import com.zemcho.ddql.service.sys.HomePageBannerService;
...
public class HomePageController {
    ...
    public Result getBannerAllList(@Validated @RequestBody HomePageBanner param, BindingResult result) {
        return homePageBannerService.selectAll();
    }

    @RequestMapping("/banner/showList")
    public Result getBannerShowList(@Validated @RequestBody HomePageBanner param, BindingResult result) {
