...
import com.zemcho.ddql.util.excel.converter.user.UserCertificateConverter;
import com.zemcho.ddql.util.excel.converter.user.UserLockConverter;
import com.zemcho.ddql.util.excel.converter.user.UserSexConverter;
...
public class CasUser {
    ...
    //金币数量
    @ExcelProperty(value = "金币数量")
    @ColumnWidth(7)
    private Integer goldCoin;

    //用户总健康币数量
    @ExcelProperty(value = "健康币数量")
    @ColumnWidth(7)
