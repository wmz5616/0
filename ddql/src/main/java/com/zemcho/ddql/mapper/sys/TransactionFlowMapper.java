...
import com.zemcho.ddql.controller.sys.vo.TransactionFlowVo;
import com.zemcho.ddql.controller.sys.vo.TransactionFlowSummaryVo;
import com.zemcho.ddql.controller.sys.vo.TransactionSummaryVo;
import com.zemcho.ddql.controller.sys.vo.SubLedgerSummaryVo;
...
public interface TransactionFlowMapper {
    ...
    /** 保存交易汇总 */
    int insertTransactionSummary(@Param("item") com.zemcho.ddql.entity.reconciliation.TransactionSummary item);

    /** 批量保存交易流水快照 */
    int batchInsertTransactionFlow(@Param("list") List<com.zemcho.ddql.entity.reconciliation.TransactionFlow> list);

    /** 保存分账汇总 */
    int insertSubLedgerSummary(@Param("item") com.zemcho.ddql.entity.reconciliation.SubLedgerSummary item);
    ...
    /** 获取分账明细统计条 */
    com.zemcho.ddql.controller.sys.vo.SubLedgerDetailSummaryVo selectSubLedgerDetailSummary(@Param("data") TransactionFlowSearchParam param);

    /** 获取分账明细列表 */
    List<com.zemcho.ddql.controller.sys.vo.SubLedgerDetailVo> selectSubLedgerDetailList(@Param("data") TransactionFlowSearchParam param);

    /** 获取分账明细总数 */
    long selectSubLedgerDetailList_COUNT(@Param("data") TransactionFlowSearchParam param);

    /** 小程序端获取商家结算记录列表 */
    List<com.zemcho.ddql.controller.wechat.shop.vo.SettlementRecordItemVo> selectWechatSettlementRecordList(@Param("data") com.zemcho.ddql.controller.wechat.shop.param.SettlementRecordSearchParam param);

    /** 小程序端获取商家结算记录总数 */
    long selectWechatSettlementRecordListCount(@Param("data") com.zemcho.ddql.controller.wechat.shop.param.SettlementRecordSearchParam param);

    /** 小程序端获取商家结算记录汇总 */
    com.zemcho.ddql.controller.wechat.shop.vo.SettlementRecordSummaryVo selectWechatSettlementRecordSummary(@Param("data") com.zemcho.ddql.controller.wechat.shop.param.SettlementRecordSearchParam param);
}
