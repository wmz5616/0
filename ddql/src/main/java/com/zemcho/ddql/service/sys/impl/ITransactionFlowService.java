...
public class ITransactionFlowService implements TransactionFlowService {
    ...
    public Result selectSubLedgerDetailList(TransactionFlowSearchParam param) {
        ...
        PageHelper.startPage(pageNum, pageSize, false);
        List<com.zemcho.ddql.controller.sys.vo.SubLedgerDetailVo> list = flowMapper.selectSubLedgerDetailList(param);

        PageInfo<com.zemcho.ddql.controller.sys.vo.SubLedgerDetailVo> pageInfo = new PageInfo<>(list);
        pageInfo.setTotal(total);
