package com.zemcho.ddql.service.wechat.auth.impl;

import com.alibaba.fastjson.JSON;
import com.zemcho.ddql.common.Result;
import com.zemcho.ddql.mapper.product.ProductCheckAdminMapper;
import com.zemcho.ddql.util.aliyun.dto.CertificationIdCardInforDto;
import com.zemcho.ddql.config.jwt.JWTUtil;
import com.zemcho.ddql.controller.wechat.auth.param.*;
import com.zemcho.ddql.controller.wechat.auth.vo.UserWechatInfoVo;
...
import com.zemcho.ddql.mapper.sys.CertificationLogMapper;
import com.zemcho.ddql.service.wechat.auth.WechatAuthService;
import com.zemcho.ddql.util.CodeRedisUtil;
import com.zemcho.ddql.util.Constant;
import com.zemcho.ddql.util.aliyun.CertificationUtil;
...
//            }
//        }
        List<Integer> productIds = productCheckAdminMapper.selectProductIdByAdminId(info.getId());
        if (productIds != null && !productIds.isEmpty()) {
            info.setCanCheckTicket(true);
        }
