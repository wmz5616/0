-- ----------------------------
-- Table structure for recharge_order_log
-- ----------------------------
CREATE TABLE IF NOT EXISTS `recharge_order_log` (
...
) ENGINE=InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT='充值购币订单操作明细表';