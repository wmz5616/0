...
class Map extends React.Component {
  ...
  componentDidMount() {
    if (!this.props.isAdd) {
      ...
      this.setState({
        locationValue: this.props.locationInfo.address,
        lng: this.props.locationName.split(',')[0],
        lat: this.props.locationName.split(',')[1],
      });
    } else {
      this.setState({ locationValue: undefined });
    }
    this.initMap();
  }
