    ...
    this.setState(
      {
        ...
        startTime: vae.time ? vae.time[0].format('YYYY-MM-DD 00:00:00') : undefined,
        endTime: vae.time ? vae.time[1].format('YYYY-MM-DD 23:59:59') : undefined,
        ...
        <div className="asd">
          ...
          >
            <Spin spinning={this.state.spinning}>
              <div style={{ backgroundColor: '#fff', padding: 24, paddingBottom: 4 }}>
              ...
              <div style={{ backgroundColor: '#fff', minHeight: window.innerHeight - 280 }}>
                <h1
                  style={{
                    fontWeight: '600',
                    fontSize: '18px',
                ...
                <Tabs defaultActiveKey="1" onChange={this.callback}>
                  ...
                  <TabPane tab="操作日志" key="2">
                    <div style={{ backgroundColor: '#fff', padding: 24, paddingTop: 14 }}>
                      <div style={{ backgroundColor: '#fff' }}>
                        <Table
                          style={{ marginTop: 25 }}
                          rowKey="taskId"
...
export default connect()(AdministratorLog);
