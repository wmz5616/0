      ...
      },
      {
        ...
        render: (text, record) => {
          return (
            <div>
              <span>
                {text == 0 ? <span className="luSe">是</span> : <span className="red">否</span>}
              </span>
            </div>
          );
        },
        ...
        render: (text, record) => {
          return (
            <div>
              ...
              {record.status == 0 ? (
                <a className="mL15" onClick={() => this.siteFrontReserve(1, record)}>
                  禁用
                </a>
              ) : (
                <a className="mL15" onClick={() => this.siteFrontReserve(0, record)}>
                  启用
                </a>
              )}
              <Popconfirm
