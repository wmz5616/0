...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean webFilter() {
        ...
        // 小程序公开内容（无需token）
        filterChainMap.put("/wechat/open/**", "anon");
        // 小程序公告内容（无需token）
        filterChainMap.put("/wechat/common/notice/**", "anon");
        filterChainMap.put("/wechat/common/config/basic", "anon");
        filterChainMap.put("/wechat/common/article/**", "anon");
        // 小程序关于我们文章详情（无需token）
        filterChainMap.put("/wechat/common/about/**", "anon");

        filterChainMap.put("/wechat/**", "mini");

        //后台数据总览
        filterChainMap.put("/monitor/**", "jwt");
