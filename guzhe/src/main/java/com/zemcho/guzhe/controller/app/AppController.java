...
public class AppController {
     ...
     * @return
     */
    @RequestMapping("/merchant/apply/settlement/qr_code")
    public Result getMerchantApplySettlementQRCode(@RequestHeader("accessToken") String accessToken) {
        return service.getMerchantApplySettlementQRCode(accessToken);
    }
     ...
     * @return
     */
    @RequestMapping("/equipment/screenshot/task")
    public Result getEquipmentScreenshotTask(@RequestHeader("accessToken") String accessToken) {
        return service.getEquipmentScreenshotTask(accessToken);
    }
     ...
     * @return
     */
    @RequestMapping("/equipment/screenshot/save")
    public Result saveEquipmentScreenshot(@Validated @RequestBody AppEquipmentScreenshotSaveParam param, BindingResult result,
                                          @RequestHeader("accessToken") String accessToken) {
        if (result.hasErrors()) {
            return new Result(10002, result.getFieldError().getDefaultMessage());
        }
        return service.saveEquipmentScreenshot(param, accessToken);
    }
}
