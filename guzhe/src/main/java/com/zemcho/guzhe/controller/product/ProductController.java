...
import com.zemcho.guzhe.controller.product.param.ProductStockUpdateParam;
...
public class ProductController {
     ...
     * 批量更新商品库存和价格（支持多规格）
     */
    @Log(description = "批量更新商品库存和价格", module = "商品管理")
    @RequestMapping("/updateStockAndPrice")
    public Result updateStockAndPrice(@RequestBody ProductStockUpdateParam param) {
        return productService.updateStockAndPrice(param);
    }
