...
public interface ScreenRentalOrderMapper {
     ...
     * @return
     */
    ScreenOrderInfoVo selectWechatOrderInfo(@Param("orderId") Long orderId);
     ...
     * @return
     */
    List<ScreenRentalOrder> selectLists(@Param("param") SearchParam param);
}
