...
public interface QualificationCertMapper {
    ...
    QualificationCert selectByUserId(@Param("userId") Integer userId);

    QualificationCert selectByShopAuditIdSimple(@Param("searchId") Integer searchId);

    QualificationCert selectExistByShopAuditId(@Param("shopAuditId") Integer shopAuditId);

    QualificationCert selectIfExistByShopAuditIdAndUserId(@Param("searchId") Integer searchId, @Param("userId") Integer userId);

    QualificationCert selectIfExistByShopIdAndUserId(@Param("searchId") Integer searchId, @Param("userId") Integer userId);
}