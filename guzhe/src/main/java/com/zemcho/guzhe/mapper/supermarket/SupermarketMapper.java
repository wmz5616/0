...
public interface SupermarketMapper {
     ...
     * @return 商超列表
     */
    List<SupermarketInfo> selectEnableByAddressKeyword(@Param("addressKeyword") String addressKeyword);
    ...
    List<SupermarketInfo> selectByCircleIds(@Param("circleIds") List<Integer> circleIds);
}
