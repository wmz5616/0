...
public interface HomeBannerMapper {
    ...
    List<HomeBanner> selectLists(@Param("sortType") Integer sortType);

    List<HomeBanner> selectbanner(@Param("sortType") Integer sortType);

    List<HomeBanner> selectbannerByType(@Param("param") SearchParam param);
}
