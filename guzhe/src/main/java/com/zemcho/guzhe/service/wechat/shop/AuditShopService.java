...
public interface AuditShopService {
     ...
     * @return result
     */
    Result submitQualification(WechatQualificationCertParam qualificationCertParam, String token);
    ...
    Result getQualificationCertDetail(SearchParam param,String token);

    Result getMerchantNotice();

    Result getCount(String token);
}
