...
public class Constant {
     ...
     * 订单库存退库延时处理监控key前缀
     */
    public static final String ORDER_NUM_REFUND_MONITOR_PREFIX = "guzhe:order:refund_num:monitor:";
     ...
     * 设备截图任务缓存key前缀
     */
    public static final String EQUIPMENT_SCREENSHOT_TASK_PREFIX = "guzhe:equipment:screenshot:task:";
}
