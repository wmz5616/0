alter table `order`
    add column `shop_id` int NOT NULL DEFAULT 0 COMMENT '商家id' after `nick_name`,
    add column `divide_status` tinyint NOT NULL DEFAULT 0 COMMENT '分账状态：0未分账，1已分账' after `refund_time`,
