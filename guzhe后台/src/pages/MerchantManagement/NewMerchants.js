          ...
          this.setState(
            {
              ...
              legalLicenceFrontUrl:
                ...
                this.state.IdPhoto[0].url, //身份证正面
              legalLicenceBackUrl:
                this.state.IdPhotoB &&
                this.state.IdPhotoB.length > 0 &&
                this.state.IdPhotoB[0].url, //身份证反面
            ...
            async () => {
              ...
              const res = await post('/guzhe/merchant/add', {
                ...mergedObj,
                // is_draft: 1,
                // stadium_id: this.state.stadium_id, //场所id
                // operationType: this.state.operationType,
            ...
            {current == 2 && (
              <>
                ...
                >
                  <p>
                    商户信息：
                    {dataDetails?.data && dataDetails?.data?.applicationNo}
                    {/* <Link to={`MerchantDetails?stadium_id=${this.state.stadium_id}&oo=1`}>
                      <a>查看详情</a>
                    </Link> */}
                  </p>
                  ...
                  <p style={{ marginLeft: 42 }}>
                    申请状态：
                    {dataDetails?.data &&
                      dataDetails?.data?.applicationNo == 'REVIEWING' && (
                        <span>
                          {' '}
                          <InfoCircleOutlined
                            style={{ color: '#1890ff' }}
                    ...
                    {dataDetails?.data &&
                      dataDetails?.data?.applicationNo == 'REVIEW_BACK' && (
                        <span>
                          {' '}
                    ...
                    {dataDetails?.data &&
                      dataDetails?.data?.applicationNo == 'COMPLETED' && (
                        <span>
